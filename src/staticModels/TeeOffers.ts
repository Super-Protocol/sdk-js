...
export type onTeeOptionUpdatedCallback = (teeOfferId: bigint, optionId: bigint, block?: BlockInfo) => void;
export type onTeeOptionDeletedCallback = (teeOfferId: bigint, optionId: bigint, block?: BlockInfo) => void;
