import {OfferInfo, OfferType, OrderInfo, TeeOfferInfo, Crypto, TcbStructure, TcbData} from "../src";
...
jest.mock("../src/models/Order", () => {
    return jest.fn().mockImplementation((id) => {
        if (id !== "order" && id !== "parentOrder" && id !== "teeOrder") {
